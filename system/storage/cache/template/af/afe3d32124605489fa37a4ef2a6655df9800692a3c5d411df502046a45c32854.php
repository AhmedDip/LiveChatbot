...
class __TwigTemplate_d04859a0a85c89fcb3f6e9b2191837226abccbbacf3479be6c8a18b95a4f46a4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
form.addEventListener(\"submit\", async (e) => {
  ...
  <img src=\"./image/user.png\" alt=\"user icon\"> <span>\${message}</span>
  </div>`;
  ...
  <img src=\"./image/chatbot.png\" alt=\"bot icon\"> <span>\${chatbotResponse}</span>
  </div>`;
});
