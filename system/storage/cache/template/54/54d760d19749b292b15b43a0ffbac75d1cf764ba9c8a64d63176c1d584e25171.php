...
class __TwigTemplate_2c0d15f1cd950f419bc9a1489d065bab0886948088ee83fe2137ff90aa3c517f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<html>
  ...
  .user-message img,
  .bot-message img {
    width: 5%; /* adjust the width of the icon */
    height: 5%; /* adjust the height of the icon */
...
form.addEventListener(\"submit\", async (e) => {
  ...
  <img src=\"/catalog/view/theme/default/image/user.png\" alt=\"user icon\"> <span>\${message}</span>
  </div>`;
  ...
  <img src=\"/catalog/view/theme/default/image/chatbot.png\" alt=\"bot icon\"> <span>\${chatbotResponse}</span>
  </div>`;
});
